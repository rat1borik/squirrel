...
```go
import "github.com/rat1borik/squirrel"
```


[![GoDoc](https://godoc.org/github.com/rat1borik/squirrel?status.png)](https://godoc.org/github.com/rat1borik/squirrel)
...
```go
import sq "github.com/rat1borik/squirrel"
...
* **How can I build an IN query on composite keys / tuples, e.g. `WHERE (col1, col2) IN ((1,2),(3,4))`? ([#104](https://github.com/rat1borik/squirrel/issues/104))**
...
* **Why doesn't `Eq{"mynumber": []uint8{1,2,3}}` turn into an `IN` query? ([#114](https://github.com/rat1borik/squirrel/issues/114))**
